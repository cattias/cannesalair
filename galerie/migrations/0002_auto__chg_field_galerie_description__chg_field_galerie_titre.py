...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Galerie.description'
        db.alter_column('galerie_galerie', 'description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Galerie.titre'
        db.alter_column('galerie_galerie', 'titre', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Galerie.description'
        raise RuntimeError("Cannot reverse this migration. 'Galerie.description' and its values cannot be restored.")

        # Changing field 'Galerie.titre'
        db.alter_column('galerie_galerie', 'titre', self.gf('django.db.models.fields.TextField')())
