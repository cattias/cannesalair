...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Photo', fields ['hash']
        db.delete_unique('galerie_photo', ['hash'])

    def backwards(self, orm):
        # Adding unique constraint on 'Photo', fields ['hash']
        db.create_unique('galerie_photo', ['hash'])
