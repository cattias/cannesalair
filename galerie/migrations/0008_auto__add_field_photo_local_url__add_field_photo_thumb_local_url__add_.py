...
#        db.add_column('galerie_photo', 'local_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
#
#        # Adding field 'Photo.thumb_local_url'
#        db.add_column('galerie_photo', 'thumb_local_url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Galerie.sortie'
        db.add_column('galerie_galerie', 'sortie', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sortie_galeries_set', null=True, to=orm['sortie.Sortie']), keep_default=False)


    def backwards(self, orm):
        
#        # Deleting field 'Photo.local_url'
#        db.delete_column('galerie_photo', 'local_url')
#
#        # Deleting field 'Photo.thumb_local_url'
#        db.delete_column('galerie_photo', 'thumb_local_url')

        # Deleting field 'Galerie.sortie'
        db.delete_column('galerie_galerie', 'sortie_id')
