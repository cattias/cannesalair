...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.is_linked'
        db.add_column('galerie_photo', 'is_linked', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Photo.is_intreatment'
        db.add_column('galerie_photo', 'is_intreatment', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.is_linked'
        db.delete_column('galerie_photo', 'is_linked')

        # Deleting field 'Photo.is_intreatment'
        db.delete_column('galerie_photo', 'is_intreatment')
