...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Photo.filesize'
        db.add_column('galerie_photo', 'filesize', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Photo.filesize'
        db.delete_column('galerie_photo', 'filesize')
