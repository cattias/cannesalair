...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Note'
        db.create_table('meteo_note', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('note', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('prevision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prevision_notes_set', to=orm['meteo.Prevision'])),
            ('activite', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activite_notes_set', to=orm['sortie.Activite'])),
            ('date_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('meteo', ['Note'])

        # Adding field 'Prevision.annexe'
        db.add_column('meteo_prevision', 'annexe',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Note'
        db.delete_table('meteo_note')

        # Deleting field 'Prevision.annexe'
        db.delete_column('meteo_prevision', 'annexe')
    ...
    models = {
        ...
        'meteo.prevision': {
            'Meta': {'ordering': "('date_previ',)", 'object_name': 'Prevision'},
