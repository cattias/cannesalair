...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field comments on 'Prevision'
        db.create_table('meteo_prevision_comments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('prevision', models.ForeignKey(orm['meteo.prevision'], null=False)),
            ('comment', models.ForeignKey(orm['comment.comment'], null=False))
        ))
        db.create_unique('meteo_prevision_comments', ['prevision_id', 'comment_id'])

    def backwards(self, orm):
        # Removing M2M table for field comments on 'Prevision'
        db.delete_table('meteo_prevision_comments')
