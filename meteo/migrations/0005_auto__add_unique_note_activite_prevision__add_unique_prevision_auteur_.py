...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Note', fields ['activite', 'prevision']
        db.create_unique('meteo_note', ['activite_id', 'prevision_id'])

        # Adding unique constraint on 'Prevision', fields ['auteur', 'date_previ']
        db.create_unique('meteo_prevision', ['auteur_id', 'date_previ'])

    def backwards(self, orm):
        # Removing unique constraint on 'Prevision', fields ['auteur', 'date_previ']
        db.delete_unique('meteo_prevision', ['auteur_id', 'date_previ'])

        # Removing unique constraint on 'Note', fields ['activite', 'prevision']
        db.delete_unique('meteo_note', ['activite_id', 'prevision_id'])
    ...
    models = {
        ...
        'meteo.note': {
            'Meta': {'unique_together': "(('prevision', 'activite'),)", 'object_name': 'Note'},
