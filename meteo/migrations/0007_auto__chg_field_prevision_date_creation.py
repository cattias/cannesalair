...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Prevision.date_creation'
        db.alter_column('meteo_prevision', 'date_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    def backwards(self, orm):

        # Changing field 'Prevision.date_creation'
        db.alter_column('meteo_prevision', 'date_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    models = {
        'auth.group': {
        ...
        'meteo.prevision': {
            ...
            'date_creation': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
