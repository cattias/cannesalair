...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Article.titre_slug'
        db.alter_column('article_article', 'titre_slug', self.gf('django.db.models.fields.SlugField')(max_length=255, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Article.titre_slug'
        db.alter_column('article_article', 'titre_slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=50, null=True))
