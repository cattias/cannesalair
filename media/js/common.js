...
$.fn.formDlg = function(options) {
    ...
    return this.each(function() {
        ...
        function checkForErrors(rsp) {
            if (rsp.stat == "ok") {
                options.success();
            } else if (rsp.fields || rsp.err) {
                if (rsp.err && rsp.err.msg) {
                    errors
                        .html(rsp.err.msg)
                        .show();
                }
...
$.fn.toggleStar = function(type, objid, default_) {
    return this.each(function() {
        ...
        // Constants
        var STAR_ON_IMG = MEDIA_URL + "images/star_on.png?" + MEDIA_SERIAL;
        var STAR_OFF_IMG = MEDIA_URL + "images/star_off.png?" + MEDIA_SERIAL;
