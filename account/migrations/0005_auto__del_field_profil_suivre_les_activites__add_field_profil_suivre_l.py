...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profil.suivre_les_sorties'
        db.add_column('account_profil', 'suivre_les_sorties', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding M2M table for field articles on 'Profil'
        db.create_table('account_profil_articles', (
        ...
        db.create_unique('account_profil_articles', ['profil_id', 'article_id'])

        # Adding M2M table for field sorties on 'Profil'
        db.create_table('account_profil_sorties', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profil', models.ForeignKey(orm['account.profil'], null=False)),
            ('sortie', models.ForeignKey(orm['sortie.sortie'], null=False))
        ))
        db.create_unique('account_profil_sorties', ['profil_id', 'sortie_id'])
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Profil.suivre_les_sorties'
        db.delete_column('account_profil', 'suivre_les_sorties')

        # Removing M2M table for field articles on 'Profil'
        db.delete_table('account_profil_articles')

        # Removing M2M table for field sorties on 'Profil'
        db.delete_table('account_profil_sorties')


    models = {
        'account.profil': {
            'Meta': {'object_name': 'Profil'},
            'articles': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'articles_suivies_set'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['article.Article']"}),
