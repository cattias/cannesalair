...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profil.qui'
        db.delete_column('account_profil', 'qui_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Profil.qui'
        raise RuntimeError("Cannot reverse this migration. 'Profil.qui' and its values cannot be restored.")
