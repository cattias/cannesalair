...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profil.last_known_activity'
        db.add_column('account_profil', 'last_known_activity', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_known_activity_set', to=orm['log.LogActivity']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profil.last_known_activity'
        db.delete_column('account_profil', 'last_known_activity_id')
    ...
    models = {
        'account.profil': {
            ...
            'last_known_activity': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'last_known_activity_set'", 'to': "orm['log.LogActivity']"}),
