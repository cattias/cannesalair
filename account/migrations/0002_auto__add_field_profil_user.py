...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profil.user'
        db.add_column('account_profil', 'user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profil.user'
        db.delete_column('account_profil', 'user_id')
