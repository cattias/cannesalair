...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field suivre_les_sorties_partype on 'Profil'
        db.create_table('account_profil_suivre_les_sorties_partype', (
        ...
        db.create_unique('account_profil_suivre_les_sorties_partype', ['profil_id', 'activite_id'])

    def backwards(self, orm):
        # Removing M2M table for field suivre_les_sorties_partype on 'Profil'
        db.delete_table('account_profil_suivre_les_sorties_partype')
    ...
    models = {
        'account.profil': {
            ...
            'suivre_les_sorties_partype': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'activites_suivies_set'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['sortie.Activite']"}),
