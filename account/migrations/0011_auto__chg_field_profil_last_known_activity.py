...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profil.last_known_activity'
        # db.alter_column('account_profil', 'last_known_activity_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['log.LogActivity']))
        pass


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Profil.last_known_activity'
        raise RuntimeError("Cannot reverse this migration. 'Profil.last_known_activity' and its values cannot be restored.")
