...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field galeries on 'Profil'
        db.create_table('account_profil_galeries', (
        ...
        db.create_unique('account_profil_galeries', ['profil_id', 'galerie_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field galeries on 'Profil'
        db.delete_table('account_profil_galeries')
