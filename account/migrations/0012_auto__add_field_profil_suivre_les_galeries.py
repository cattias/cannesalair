...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profil.suivre_les_galeries'
        db.add_column('account_profil', 'suivre_les_galeries', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profil.suivre_les_galeries'
        db.delete_column('account_profil', 'suivre_les_galeries')
