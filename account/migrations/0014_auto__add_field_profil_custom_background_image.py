...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Profil.custom_background_image'
        db.add_column('account_profil', 'custom_background_image', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Profil.custom_background_image'
        db.delete_column('account_profil', 'custom_background_image')
