...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sortie.titre_slug'
        db.add_column('sortie_sortie', 'titre_slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=255, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sortie.titre_slug'
        db.delete_column('sortie_sortie', 'titre_slug')
