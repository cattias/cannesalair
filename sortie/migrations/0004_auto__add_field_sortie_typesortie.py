...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sortie.typesortie'
        db.add_column('sortie_sortie', 'typesortie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sortie_type_set', to=orm['sortie.SortieType']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sortie.typesortie'
        db.delete_column('sortie_sortie', 'typesortie_id')
