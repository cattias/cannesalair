...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Sortie.canceled'
        db.add_column('sortie_sortie', 'canceled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Sortie.canceled'
        db.delete_column('sortie_sortie', 'canceled')
