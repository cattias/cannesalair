...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Sortie.compterendu'
        db.delete_column('sortie_sortie', 'compterendu')


    def backwards(self, orm):
        
        # Adding field 'Sortie.compterendu'
        db.add_column('sortie_sortie', 'compterendu', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
