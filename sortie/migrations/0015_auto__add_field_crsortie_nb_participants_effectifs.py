...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CRSortie.nb_participants_effectifs'
        db.add_column('sortie_crsortie', 'nb_participants_effectifs',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'CRSortie.nb_participants_effectifs'
        db.delete_column('sortie_crsortie', 'nb_participants_effectifs')
    ...
    models = {
        ...
        'sortie.crsortie': {
            ...
            'nb_participants_effectifs': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'sortie.sortie': {
            ...
            'typesortie': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'related_name': "'sortie_type_set'", 'to': "orm['sortie.SortieType']"})
        },
        'sortie.sortieoldslugs': {
            ...
            'titre_slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '255'})
        },
        'sortie.sortietype': {
