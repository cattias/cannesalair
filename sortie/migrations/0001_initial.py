...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('sortie_activite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('activite', self.gf('django.db.models.fields.TextField')()),
            ('date_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sortie', ['Activite'])

        # Adding model 'Sortie'
        db.create_table('sortie_sortie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('auteur', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sortie_auteur_set', to=orm['auth.User'])),
            ('titre', self.gf('django.db.models.fields.TextField')()),
            ('lieu', self.gf('django.db.models.fields.TextField')()),
            ('rdv', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('compterendu', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('date_debut', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_fin', self.gf('django.db.models.fields.DateTimeField')()),
            ('date_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sortie', ['Sortie'])

        # Adding M2M table for field comments on 'Sortie'
        db.create_table('sortie_sortie_comments', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sortie', models.ForeignKey(orm['sortie.sortie'], null=False)),
            ('comment', models.ForeignKey(orm['comment.comment'], null=False))
        ))
        db.create_unique('sortie_sortie_comments', ['sortie_id', 'comment_id'])

        # Adding M2M table for field activites on 'Sortie'
        db.create_table('sortie_sortie_activites', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('sortie', models.ForeignKey(orm['sortie.sortie'], null=False)),
            ('activite', models.ForeignKey(orm['sortie.activite'], null=False))
        ))
        db.create_unique('sortie_sortie_activites', ['sortie_id', 'activite_id'])

        # Adding model 'Participant'
        db.create_table('sortie_participant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('qui', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participant_user_set', to=orm['auth.User'])),
            ('sortie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participant_sortie_set', to=orm['sortie.Sortie'])),
            ('statut', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('date_update', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('sortie', ['Participant'])


    def backwards(self, orm):
        
        # Deleting model 'Activite'
        db.delete_table('sortie_activite')

        # Deleting model 'Sortie'
        db.delete_table('sortie_sortie')

        # Removing M2M table for field comments on 'Sortie'
        db.delete_table('sortie_sortie_comments')

        # Removing M2M table for field activites on 'Sortie'
        db.delete_table('sortie_sortie_activites')

        # Deleting model 'Participant'
        db.delete_table('sortie_participant')
