...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SpecialParticipant'
        db.create_table('sortie_specialparticipant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('qui', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participant_garant_user_set', to=orm['auth.User'])),
            ('nom', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('sortie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='participant_special_sortie_set', to=orm['sortie.Sortie'])),
            ('statut', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('date_update', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('sortie', ['SpecialParticipant'])


    def backwards(self, orm):
        
        # Deleting model 'SpecialParticipant'
        db.delete_table('sortie_specialparticipant')
    ...
    models = {
        ...
        'sortie.specialparticipant': {
            'Meta': {'object_name': 'SpecialParticipant'},
            'date_update': ('django.db.models.fields.DateTimeField', [], {}),
            'email': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'qui': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'participant_garant_user_set'", 'to': "orm['auth.User']"}),
            'sortie': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'participant_special_sortie_set'", 'to': "orm['sortie.Sortie']"}),
            'statut': ('django.db.models.fields.CharField', [], {'max_length': '20'})
        }
    }
