...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SortieType'
        db.create_table('sortie_sortietype', (
        ...
        db.send_create_signal('sortie', ['SortieType'])


    def backwards(self, orm):
        
        # Deleting model 'SortieType'
        db.delete_table('sortie_sortietype')
