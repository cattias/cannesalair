...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Sortie.type'
        db.delete_column('sortie_sortie', 'type')


    def backwards(self, orm):
        
        # We cannot add back in field 'Sortie.type'
        raise RuntimeError(
            "Cannot reverse this migration. 'Sortie.type' and its values cannot be restored.")
