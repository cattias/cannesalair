...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CRSortie'
        db.create_table('sortie_crsortie', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('auteur', self.gf('django.db.models.fields.related.ForeignKey')(related_name='crsortie_auteur_set', to=orm['auth.User'])),
            ('compterendu', self.gf('django.db.models.fields.TextField')()),
            ('kilometrage', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('peages', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True)),
            ('nb_voitures', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('participants_effectifs', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('date_creation', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('sortie', ['CRSortie'])

        # Adding field 'Sortie.cr'
        db.add_column('sortie_sortie', 'cr', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='compte_rendu_sortie_set', null=True, to=orm['sortie.CRSortie']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CRSortie'
        db.delete_table('sortie_crsortie')

        # Deleting field 'Sortie.cr'
        db.delete_column('sortie_sortie', 'cr_id')
    ...
    models = {
        ...
        'sortie.sortieoldslugs': {
            'Meta': {'object_name': 'SortieOldSlugs'},
            'date_creation': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'sortie': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sortie_oldslugs_set'", 'to': "orm['sortie.Sortie']"}),
