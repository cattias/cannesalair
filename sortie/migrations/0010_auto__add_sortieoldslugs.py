...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SortieOldSlugs'
        db.create_table('sortie_sortieoldslugs', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sortie', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sortie_oldslugs_set', to=orm['sortie.Sortie'])),
        ...
        db.send_create_signal('sortie', ['SortieOldSlugs'])


    def backwards(self, orm):
        
        # Deleting model 'SortieOldSlugs'
        db.delete_table('sortie_sortieoldslugs')
